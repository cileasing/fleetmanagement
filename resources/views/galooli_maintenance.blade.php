...
<head>
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    ...
    <!-- Select2 -->
  <link rel="stylesheet" href="https://sys.c-ileasing.com/bower_components/select2/dist/css/select2.min.css">
...
<div class="login-box">
  <div class="login-logo">
      <a href=""><b>{{ $title}} </b>Request <small>GALOOLI</small></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Select Vehicle</p>
...
?>
<script src="{{ URL::asset('js/galJSON.js') }}"></script>

<?php
}else if($url == "fueling_request_galooli"){
?>

<script src="{{ URL::asset('js/galJSON_FUEL.js') }}"></script>
<?php
...
?>
 ...
 <!-- Select2 -->
  <script src="https://sys.c-ileasing.com/bower_components/select2/dist/js/select2.full.min.js"></script>  
