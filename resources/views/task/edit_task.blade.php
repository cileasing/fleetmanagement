                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-12">
                                        ...
                                        <div class="box-body pad">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $reservation_date; ?>" type="text" class="form-control datepicker" id="datepicker" name="office" placeholder="">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $comp; ?>" type="text" class="form-control" id="office" name="office" placeholder="">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $officeName; ?>" type="text" class="form-control" id="office" name="office" placeholder="">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $client_type; ?>" type="text" class="form-control" id="office" name="office" placeholder="">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $credit_type; ?>" type="text" class="form-control" id="office" name="office" placeholder="">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $clientName; ?>" type="text" class="form-control" id="office" name="office" placeholder="">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $contact_email_address; ?>" type="text" class="form-control" id="office" name="office" placeholder="">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $contact_phone_number; ?>" type="text" class="form-control" id="office" name="office" placeholder="">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"><?php $comment; ?></textarea>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $task_status ?>" type="text" class="form-control" id="office" name="office" placeholder="">
                            ...
                            <div class="box-footer">
                                ...
                                <button  type="submit" id="save_reservation" class="btn btn-primary">UPDATE</button>
                                        ...
                                        <div class="added_main_trips">
                                            <table class="table table-secondary table-responsive table-condensed table-hover table-bordered">
                                                ...
                                                if ($trips) {
                                                    ...
                                                    <a href=''><span class='fa fa-edit'></span></a></td>
                                                   </tr>";
                                                    }
                                                }
                                                ?>
