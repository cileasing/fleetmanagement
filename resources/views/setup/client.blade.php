            ...
            <form role="form" id="contractSetup" name="contractSetup">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Contract Owner</label>
                  <input type="type" class="form-control" id="clientName" name="clientName" placeholder="Enter Name">
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <button id="setupClient" class="btn btn-primary">SAVE</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
...
<script src="{{ URL::asset('js/clientsetup.js') }}"></script>
